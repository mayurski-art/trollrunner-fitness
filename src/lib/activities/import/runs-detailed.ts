...
export const DETAILED_RUNS: DetailedRun[] = [
  ...
  },
  {
    date: "2026-08-25",
    distanceMi: "5.20",
    durationMin: fromPace(5.2, 11, 58),
    elevationFt: "",
    avgHeartRate: 142,
    trainingLoad: 89,
    calories: 756,
    notes: "11:58/mi average. 100% efficiency, training load 89, 756 cal.",
  },
  {
    date: "2026-08-27",
    distanceMi: "3.16",
    durationMin: fromPace(3.16, 12, 14),
    elevationFt: "",
    avgHeartRate: 143,
    trainingLoad: 62,
    calories: 474,
    notes: "12:14/mi average. 98% efficiency, training load 62, 474 cal.",
  },
  {
    date: "2026-08-29",
    distanceMi: "8.01",
    durationMin: fromPace(8.01, 9, 26),
    elevationFt: "",
    avgHeartRate: 171,
    trainingLoad: 291,
    calories: 1244,
    notes:
      "First of two runs this day. 9:26/mi average, 102% efficiency, training load 291, 1244 cal.",
  },
  {
    date: "2026-08-29",
    distanceMi: "2.58",
    durationMin: fromPace(2.58, 9, 25),
    elevationFt: "",
    avgHeartRate: 175,
    trainingLoad: 104,
    calories: 411,
    notes:
      "Second run this day. 9:25/mi average, 96% efficiency, training load 104, 411 cal.",
  },
  {
    date: "2026-08-31",
    distanceMi: "1.10",
    durationMin: fromPace(1.1, 19, 39),
    elevationFt: "",
    trainingLoad: 17,
    calories: 169,
    title: "Indoor run",
    notes:
      "Indoor run, 7% average grade. 19:39/mi average, training load 17, 169 cal.",
  },
  {
    date: "2026-09-01",
    distanceMi: "5.87",
    durationMin: fromPace(5.87, 11, 12),
    elevationFt: "",
    avgHeartRate: 143,
    trainingLoad: 117,
    calories: 810,
    notes: "11:12/mi average. 102% efficiency, training load 117, 810 cal.",
  },
  {
    date: "2026-09-02",
    distanceMi: "3.24",
    durationMin: fromPace(3.24, 11, 30),
    elevationFt: "",
    trainingLoad: 44,
    calories: 428,
    notes: "11:30/mi average. 102% efficiency, training load 44, 428 cal.",
  },
  {
    date: "2026-09-03",
    distanceMi: "1.58",
    durationMin: fromPace(1.58, 19, 44),
    elevationFt: "",
    avgHeartRate: 125,
    trainingLoad: 23,
    calories: 235,
    title: "Indoor run",
    notes:
      "Indoor run, 6% average incline grade. 19:44/mi average, training load 23, 235 cal.",
  },
];
...
export const CROSS_TRAINING: CrossTraining[] = [
  ...
  },
  {
    ...
    title: "Indoor bike",
    distanceMi: "4.70",
    durationMin: ((4.7 / 10) * 60).toFixed(1),
    avgHeartRate: 119,
    trainingLoad: 17,
    calories: 196,
    notes: "Indoor cycling. 10 mph average, training load 17, 196 cal.",
  },
  {
    date: "2026-09-02",
    title: "Indoor bike",
    distanceMi: "3.62",
    durationMin: ((3.62 / 10.2) * 60).toFixed(1),
    avgHeartRate: 118,
    trainingLoad: 12,
    calories: 145,
    notes: "Indoor cycling. 10.2 mph average, training load 12, 145 cal.",
  },
];
